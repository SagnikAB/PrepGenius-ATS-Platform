...
\begin{table}[htbp]
\caption{Taxonomic Comparison of ATS Retrieval and Evaluation Paradigms}
\label{tab:taxonomy}
\begin{center}
...
\begin{table}[htbp]
\caption{Multi-Factor Scoring Dimensions and Configured Weights}
\label{tab:weights}
\begin{center}
\begin{tabular}{llr}
\toprule
...
\caption{PrepGenius Hybrid Retrieval and Re-ranking Algorithm}
\label{alg:hybrid}
\begin{algorithmic}[1]
...
\bibitem{b3} A. Vaswani \textit{et al.}, ``Attention is all you need,'' in \textit{Proc. NeurIPS}, 2017, pp. 5998--5008.
